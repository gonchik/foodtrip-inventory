...
//	vendor('selenium'.DS.'selenium_test_suite', 'selenium'.DS.'selenium_test_case');
	App::import('vendor', 'SeleniumTestSuite', array('file' => '../vendors/selenium/selenium_test_suite'));
	App::import('vendor', 'SeleniumTestCase', array('file' => '../vendors/selenium/selenium_test_case'));
