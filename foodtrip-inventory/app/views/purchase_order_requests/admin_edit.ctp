...
<?php echo $this->Form->create('PurchaseOrderRequest');?>
	<fieldset>
 		<legend><?php __('Admin Edit Purchase Order Request'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('PurchaseOrderRequest.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('PurchaseOrderRequest.id'))); ?></li>
