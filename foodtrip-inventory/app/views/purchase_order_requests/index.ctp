		...
		<td class="actions">
			...
			<?php
				if($purchaseOrderRequest['PurchaseOrderRequest']['dateApproved'] == null) {
					echo $this->Html->link(__('Edit', true), array('action' => 'edit', $purchaseOrderRequest['PurchaseOrderRequest']['id']));					
					echo $this->Html->link(__('Approve', true), array('action' => 'approve', $purchaseOrderRequest['PurchaseOrderRequest']['id']), null, sprintf(__('Are you sure you want to approve # %s?', true), $purchaseOrderRequest['PurchaseOrderRequest']['id']));	
				}
			?>
			<?php 
				if($purchaseOrderRequest['PurchaseOrderRequest']['dateCancelled'] == null) {
					echo $this->Html->link(__('Cancel', true), array('action' => 'cancel', $purchaseOrderRequest['PurchaseOrderRequest']['id']), null, sprintf(__('Are you sure you want to cancel # %s?', true), $purchaseOrderRequest['PurchaseOrderRequest']['id']));	
				}
			?>
		</td>
	</tr>
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Manage Purchase Order Request Items', true), array('controller' => 'purchase_order_request_items', 'action' => 'index'));?></li>
