...
<?php echo $this->Form->create('StationAssignment');?>
	<fieldset>
 		<legend><?php __('Admin Edit Station Assignment'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('StationAssignment.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('StationAssignment.id'))); ?></li>
